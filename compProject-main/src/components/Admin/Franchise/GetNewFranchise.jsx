    ...
    const findfranchise = async () => {
        try {
          ...
          const franchise = await axios.get(
            "http://localhost:8000/api/admin/get-new-franchise-requests"
          );
      ...
      const updatefranchise = async(id)=>{
        try {
             
          const franchise = await axios.get(`http://localhost:8000/api/admin/verify-franchise/${id}`)
                ...
                return (
                  <>
                    ...
                    <Td>{item._id}</Td>
                      ...
                      <Td>
                        <Button onClick={()=>{updatefranchise(`${item._id}`)}} >click to verify</Button>
                      </Td>
                    </Tr>
                  </>
                );
...
export default GetNewFranchise
