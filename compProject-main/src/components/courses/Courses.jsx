...
const Courses = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    const response = await axios.get(`http://localhost:8000/api/course/get-all-courses?category=${catagory}&duration=${duration}`)
    .then((response) => {
  ...
  return (
    <div>
          ...
          <div>
            <div>
              <div>
                {/* <label htmlFor="stateSelect"> Distict:</label> */}
                <br />
                <select id="DistrictSelect" name="state" value={catagory}
                onChange={handleCatagoryChange}>
                  ...
                  <option value="Course For Karnataka State">Course For Karnataka State</option>
                  <option value="Course For Jharkhand State">Course For Jharkhand State</option>
                  <option value="Programming & Web Designing">Programming &amp; Web Designing</option>
                  {/* Add more state options as needed */}
                </select>
              </div>
            </div>
            <div>
              <div>
                {/* <label htmlFor="stateSelect"> Distict:</label> */}
                <br />
                <select id="DistrictSelect" name="state" value={duration}
      ...
      <div className="coursesContainer">
        <div className="content">
          <div className="para"><p>Available Courses</p></div>
